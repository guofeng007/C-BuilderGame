       ...
       // 1;6
        ...
        {     // x;y;flag
                ...
                int y = yStr.ToInt();
                 ...
                 y= y<<16 ;
                 unsigned long result = y+x ;
                   HWND desktop =  GetDesktopWindow();
                 //left double click
                 if(flag == 1)
                 {   SendMessage(desktop,WM_MOUSEMOVE,0 ,LPARAM(result));
                     SendMessage(desktop,WM_LBUTTONDBLCLK,0,LPARAM(result));

                 }
                 //right
                 if(flag == 2)
                 {       SendMessage(desktop,WM_MOUSEMOVE,0 ,LPARAM(result));
                         SendMessage(desktop,WM_RBUTTONDBLCLK,0,LPARAM(result));
